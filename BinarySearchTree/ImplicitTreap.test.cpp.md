...
data:
  ...
  attributes:
    ...
    links:
    - https://ei1333.github.io/library/structure/bbst/randomized-binary-search-tree-lazy.cpp
    - https://judge.yosupo.jp/problem/dynamic_sequence_range_affine_range_sum
    - https://xuzijian629.hatenablog.com/entry/2018/12/08/000452
  bundledCode: "#line 1 \"BinarySearchTree/ImplicitTreap.test.cpp\"\n#include<bits/stdc++.h>\n\
    using namespace std;\n#define ALL(x) begin(x),end(x)\n#define rep(i,n) for(int\
    \ i=0;i<(n);i++)\n#define debug(v) cout<<#v<<\":\";for(auto x:v){cout<<x<<' ';}cout<<endl;\n\
    #define mod 998244353\nusing ll=long long;\nconst int INF=1000000000;\nconst ll\
    \ LINF=1001002003004005006ll;\nint dx[]={1,0,-1,0},dy[]={0,1,0,-1};\n// ll gcd(ll\
  ...
  requiredBy: []
  timestamp: '2021-01-01 23:32:50+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: BinarySearchTree/ImplicitTreap.test.cpp
layout: document
redirect_from:
- /verify/BinarySearchTree/ImplicitTreap.test.cpp
- /verify/BinarySearchTree/ImplicitTreap.test.cpp.html
