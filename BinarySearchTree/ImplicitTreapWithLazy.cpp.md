...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"BinarySearchTree/ImplicitTreapWithLazy.cpp\"\ntemplate<typename\
...
layout: document
redirect_from:
- /library/BinarySearchTree/ImplicitTreapWithLazy.cpp
- /library/BinarySearchTree/ImplicitTreapWithLazy.cpp.html
